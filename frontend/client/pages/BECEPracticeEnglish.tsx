...
export default function BECEPracticeEnglish() {
  ...
  useEffect(() => {
    const loadInitialData = async () => {
      try {
        setLoading(true);
        console.log('Loading BECE English practice data...');
        ...
        console.log('Loading papers for english_language...');
        try {
          const papers = await apiClient.getBECEPracticeBySubject('english_language');
  ...
  useEffect(() => {
    const loadPaper = async () => {
      if (!currentYear || availablePapers.length === 0) return;
  ...
  if (error) {
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex items-center justify-center py-20">
          <div className="text-center">
            <div className={`border rounded-lg p-8 max-w-md ${
              isPremiumError 
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">
                    BECE English Language Practice
                  </h1>
