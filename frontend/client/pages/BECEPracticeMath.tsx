...
export default function BECEPracticeMath() {
  ...
  useEffect(() => {
    const loadInitialData = async () => {
      try {
        setLoading(true);
        console.log('Loading BECE Math practice data...');
        ...
        console.log('Loading papers for mathematics...');
        try {
          const papers = await apiClient.getBECEPracticeBySubject('mathematics');
